 ...
 */
import { SDKAPPID, SDK_SECRETKEY, EXPIRETIME } from '@app/config';
...
if (SDKAPPID === '' || SDK_SECRETKEY === '') {
  alert('请先配置好您的账号信息： SDKAPPID 及 SDK_SECRETKEY '
    + '\r\n\r\nPlease configure your SDKAPPID/SDK_SECRETKEY in src/app/config.js');
}
