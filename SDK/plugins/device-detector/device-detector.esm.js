...
`)))},200),this.showConnectResult=!0,this.setAttribute("showconnectresult",this.showConnectResult),clearInterval(this.progressInterval)}},150))}prepareInfo(){return this.isChinese?`\u8BBE\u5907\u68C0\u6D4B\u524D\u8BF7\u786E\u8BA4\u8BBE\u5907\u8FDE\u63A5\u4E86${this.hasCameraDetect()?"\u6444\u50CF\u5934":""}${this.hasMicrophoneDetect()?"\u3001\u9EA6\u514B\u98CE":""}${this.hasSpeakerDetect()?"\u3001\u626C\u58F0\u5668":""}${this.hasNetworkDetect()?"\u548C\u7F51\u7EDC":""}`:`Make sure the device is connected before testing the device ${this.hasCameraDetect()?"camera":""}${this.hasMicrophoneDetect()?", microphone":""}${this.hasSpeakerDetect()?", speaker":""}${this.hasNetworkDetect()?" and network":""}`}judgeList(e){let i=this.shadowRoot.querySelector(".camerasvg"),r=this.shadowRoot.querySelector(".microphonesvg"),V=this.shadowRoot.querySelector(".speakersvg"),o=this.shadowRoot.querySelector(".networksvg");e.indexOf("camera")>=0?i.style.display="block":i.style.display="none",e.indexOf("microphone")>=0?r.style.display="block":r.style.display="none",e.indexOf("speaker")>=0?V.style.display="block":V.style.display="none",e.indexOf("network")>=0?o.style.display="block":o.style.display="none"}async getDeviceConnectResult(){let e=[],i=[],r=[];try{let{cameras:l,speakers:u,microphones:g}=await J();e=l,i=g,r=u}catch(l){}let V=e.length>0,o=i.length>0,s=this.hasSpeakerDetect()?this.isFirefoxOrSafariOrIOS||r.length>0:!0,A=this.hasNetworkDetect()?await Es():!0,n={hasCameraDevice:V,hasMicrophoneDevice:o,hasSpeakerDevice:s,hasNetworkConnect:A,hasCameraConnect:!1,hasMicrophoneConnect:!1,hasSpeakerConnect:s};this.deviceState=n,this.remindAnimation=!1,this.connectResult=this.getDeviceConnectInfo(n);let d=[];V&&d.push(new Promise((l,u)=>{navigator.mediaDevices.getUserMedia({video:!0,audio:!1}).then(g=>{this.remindAnimation=!1,n=H(j({},n),{hasCameraConnect:!0}),this.deviceState=n,this.connectResult=this.getDeviceConnectInfo(n),g.getTracks()[0].stop(),l()}).catch(g=>{vi(g),l()})})),o&&d.push(new Promise((l,u)=>{navigator.mediaDevices.getUserMedia({video:!1,audio:!0}).then(g=>{this.remindAnimation=!1,n=H(j({},n),{hasMicrophoneConnect:o}),this.deviceState=n,this.connectResult=this.getDeviceConnectInfo(n),g.getTracks()[0].stop(),l()}).catch(g=>{vi(g),l()})})),await Promise.all(d),this.handler(this.showConnectResult)}getDeviceConnectInfo(e){this.remindAnimation=!1;let i="\u8FDE\u63A5\u51FA\u9519\uFF0C\u8BF7\u91CD\u8BD5";return this.isChinese||(i="Connection error, please try again"),e.hasCameraConnect&&e.hasMicrophoneConnect&&e.hasSpeakerConnect&&e.hasNetworkConnect?(this.isChinese?i=this.hasNetworkDetect?"\u8BBE\u5907\u53CA\u7F51\u7EDC\u8FDE\u63A5\u6210\u529F\uFF0C\u8BF7\u5F00\u59CB\u8BBE\u5907\u68C0\u6D4B":"\u8BBE\u5907\u8FDE\u63A5\u6210\u529F\uFF0C\u8BF7\u5F00\u59CB\u8BBE\u5907\u68C0\u6D4B":i=this.hasNetworkDetect?"Device and network connection are successful, start device detection":"Device connection successful, start device detection",{info:i,success:!0}):e.hasCameraDevice&&e.hasMicrophoneDevice&&e.hasSpeakerDevice?e.hasCameraConnect&&e.hasMicrophoneConnect?e.hasNetworkConnect?{info:i,success:!1}:(this.isChinese?i="\u7F51\u7EDC\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5":i="Network connection failed, please check network connection",{info:i,success:!1,remind:this.isChinese?S.networkFailAttention:S.networkFailAttentionEng}):(this.isChinese?i=e.hasNetworkConnect?"\u8BF7\u5141\u8BB8\u6D4F\u89C8\u5668\u53CA\u7F51\u9875\u8BBF\u95EE\u6444\u50CF\u5934/\u9EA6\u514B\u98CE\u8BBE\u5907":"\u8BF7\u5141\u8BB8\u6D4F\u89C8\u5668\u53CA\u7F51\u9875\u8BBF\u95EE\u6444\u50CF\u5934/\u9EA6\u514B\u98CE\u8BBE\u5907\uFF0C\u5E76\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5":i=e.hasNetworkConnect?"Please allow browser and web access to camera/microphone devices":"Please allow browser and web access to camera/microphone devices, and check the network connection",this.remindAnimation=!0,{info:i,success:!1,remind:this.isMobile?this.isChinese?S.mobileFailAttention:S.mobileFailAttentionEng:this.isChinese?S.deviceFailAttention:S.deviceFailAttentionEng}):(this.isChinese?i=`\u68C0\u6D4B\u5230${e.hasCameraDevice?"":"\u3010\u6444\u50CF\u5934\u3011"}${e.hasMicrophoneDevice?"":"\u3010\u9EA6\u514B\u98CE\u3011"}${e.hasSpeakerDevice?"":"\u3010\u626C\u58F0\u5668\u3011"}\u8BBE\u5907\u4E0D\u5B58\u5728\uFF0C\u8BF7\u68C0\u67E5\u8BBE\u5907\u8FDE\u63A5`:i=`No ${e.hasCameraDevice?"":"\u3010camera\u3011"}${e.hasMicrophoneDevice?"":"\u3010microphone\u3011"}${e.hasSpeakerDevice?"":"\u3010speaker\u3011"} device detected, please check the device connection`,{info:i,success:!1})}handleReset(){this.progress=0,this.showConnectResult=!1,this.setAttribute("showconnectresult",this.showConnectResult)}async attributeChangedCallback(e,i,r){if(e==="showconnectresult"){if(r==="true"){let V=this.shadowRoot.querySelector(".camerasvg"),o=this.shadowRoot.querySelector(".microphonesvg"),s=this.shadowRoot.querySelector(".speakersvg"),A=this.shadowRoot.querySelector(".networksvg"),n=this.shadowRoot.querySelector(".outer-progress"),d=this.shadowRoot.querySelector("trtc-custom-button");if(this.deviceState.hasCameraConnect?(V.classList.remove("connect-fail"),V.classList.add("connect-success")):V.classList.add("connect-fail"),this.deviceState.hasMicrophoneConnect?(o.classList.remove("connect-fail"),o.classList.add("connect-success")):o.classList.add("connect-fail"),this.deviceState.hasSpeakerConnect?(s.classList.add("connect-success"),s.classList.remove("connect-fail")):s.classList.add("connect-fail"),this.deviceState.hasNetworkConnect?(A.classList.add("connect-success"),A.classList.remove("connect-fail")):A.classList.add("connect-fail"),this.showReconnectButton()&&(d.setAttribute("type","outlined"),this.isChinese?d.innerHTML="\u91CD\u65B0\u8FDE\u63A5":d.innerHTML="Reconnect",d.addEventListener("click",()=>{this.remindAnimation=!1;let l=new CustomEvent("remind-changed",{detail:this.remindAnimation});this.dispatchEvent(l);let u=new Date().getTime(),g=M();g&&g.kvStatManager.addFailedEvent({key:591704,error:u-this.startTime}),this.handleReset()})),this.showStartDetectButton()&&(d.setAttribute("type","contained"),this.setAttribute("connectstage",1),this.isChinese?d.innerHTML="\u5F00\u59CB\u68C0\u6D4B":d.innerHTML="Start detection"),this.showConnectResult){n.style.display="none",this.shadowRoot.querySelector(".gray-text").style.display="none";let l=this.shadowRoot.querySelector(".result");l.style.display="block",this.connectResult.success===!0?l.classList.add("green-text"):(l.classList.add("red-text"),this.connectResult.remind&&(this.shadowRoot.querySelector(".error-connect").style.display="inline-block")),l.querySelector("span").innerHTML=this.connectResult.info}}else if(r==="false"){let V=this.shadowRoot.querySelector(".camerasvg"),o=this.shadowRoot.querySelector(".microphonesvg"),s=this.shadowRoot.querySelector(".speakersvg"),A=this.shadowRoot.querySelector(".networksvg"),n=this.shadowRoot.querySelector(".outer-progress"),d=this.shadowRoot.querySelector("trtc-custom-button");n.style.display="block",this.shadowRoot.querySelector(".result").classList.remove("green-text"),this.shadowRoot.querySelector(".result").classList.remove("red-text"),V.classList.remove("connect-fail"),V.classList.remove("connect-success"),o.classList.remove("connect-fail"),o.classList.remove("connect-success"),s.classList.remove("connect-fail"),s.classList.remove("connect-success"),A.classList.remove("connect-fail"),A.classList.remove("connect-success"),d.setAttribute("type","disabled"),this.isChinese?d.innerHTML="\u5F00\u59CB\u68C0\u6D4B":d.innerHTML="Start detection",this.getDeviceConnectResult(),this.shadowRoot.querySelector(".gray-text").style.display="block";let l=this.shadowRoot.querySelector(".result");l.style.display="none",this.shadowRoot.querySelector(".error-connect").style.display="none"}}}};h(S,"observedAttributes",["stepnamelist","showconnectresult"]),h(S,"properties",{showRemind:{type:Boolean},constTime:{type:Number}}),h(S,"deviceFailAttention","1. \u82E5\u6D4F\u89C8\u5668\u5F39\u51FA\u63D0\u793A\uFF0C\u8BF7\u9009\u62E9\u201C\u5141\u8BB8\u201D<br>2. \u82E5\u6740\u6BD2\u8F6F\u4EF6\u5F39\u51FA\u63D0\u793A\uFF0C\u8BF7\u9009\u62E9\u201C\u5141\u8BB8\u201D<br>3. \u68C0\u67E5\u7CFB\u7EDF\u8BBE\u7F6E\uFF0C\u5141\u8BB8\u6D4F\u89C8\u5668\u8BBF\u95EE\u6444\u50CF\u5934\u53CA\u9EA6\u514B\u98CE<br>4. \u68C0\u67E5\u6D4F\u89C8\u5668\u8BBE\u7F6E\uFF0C\u5141\u8BB8\u7F51\u9875\u8BBF\u95EE\u6444\u50CF\u5934\u53CA\u9EA6\u514B\u98CE<br>5. \u68C0\u67E5\u6444\u50CF\u5934/\u9EA6\u514B\u98CE\u662F\u5426\u6B63\u786E\u8FDE\u63A5\u5E76\u5F00\u542F<br>6. \u5C1D\u8BD5\u91CD\u65B0\u8FDE\u63A5\u6444\u50CF\u5934/\u9EA6\u514B\u98CE<br>7. \u5C1D\u8BD5\u91CD\u542F\u8BBE\u5907\u540E\u91CD\u65B0\u68C0\u6D4B"),h(S,"deviceFailAttentionEng",'1. If the browser prompts, select "Allow"<br>2. If the antivirus software prompts, select "Allow"<br>3. Check system settings to allow camera and microphone<br>4. Check browser settings to allow camera and microphone<br>5. Check camera/microphone turned on<br>6. Try reconnecting the camera/microphone<br>7. Try restarting the device and retesting'),h(S,"mobileFailAttention","1. \u524D\u5F80\u624B\u673A\u8BBE\u7F6E,\u6253\u5F00\u672C\u5E94\u7528\u7684\u76F8\u673A\u548C\u9EA6\u514B\u98CE\u6743\u9650<br>2. \u91CD\u65B0\u5237\u65B0\u672C\u9875\u5E76\u5141\u8BB8\u76F8\u673A\u548C\u9EA6\u514B\u98CE\u6743\u9650<br>"),h(S,"mobileFailAttentionEng","1.  Go to your phone Settings to allow camera and microphone permissions for this app <br>2. Refresh this page and allow camera and microphone permissions <br>"),h(S,"networkFailAttention","1. \u8BF7\u68C0\u67E5\u8BBE\u5907\u662F\u5426\u8054\u7F51<br>2. \u8BF7\u5237\u65B0\u7F51\u9875\u540E\u518D\u6B21\u68C0\u6D4B<br>3. \u8BF7\u5C1D\u8BD5\u66F4\u6362\u7F51\u7EDC\u540E\u518D\u6B21\u68C0\u6D4B"),h(S,"networkFailAttentionEng","1. Check if the device is connected to the network<br>2. Refresh the page and test again<br>3. Try again after changing the network");var ot=S;customElements.get("trtc-device-connect")||customElements.define("trtc-device-connect",ot);var fe=class extends f{constructor(){super(),this.deviceList=[],this.activeDevice={},this.activeDeviceId="",this.attachShadow({mode:"open"})}async getDeviceListData(){var r;let e=await Ms(this.deviceType),i=e.map(V=>V.deviceId);this.deviceList=e,this.choseDevice&&i.indexOf(this.choseDevice.deviceId)>=0?(this.activeDevice=e.find(V=>V.deviceId===this.choseDevice.deviceId),this.activeDeviceId=this.choseDevice.deviceId):(this.activeDevice=e[0],this.activeDeviceId=(r=e[0])==null?void 0:r.deviceId),this.onChange(this.activeDevice),this.requestUpdate()}async firstUpdated(){await this.getDeviceListData(),navigator.mediaDevices.addEventListener("devicechange",async()=>{let e=await Ms(this.deviceType);this.deviceList=e,e[0].deviceId!==this.activeDeviceId&&(this.activeDevice=e[0],this.activeDeviceId=e[0].deviceId,this.onChange(this.activeDevice)),this.requestUpdate()})}disconnectedCallback(){this.remove()}handleChange(e){let i=e.target.value,r=M();r&&r.kvStatManager.addEnum({key:591713,value:1});let V=this.deviceList.find(o=>o.deviceId===i);this.activeDevice=V,this.activeDeviceId=i,this.onChange(this.activeDevice),this.requestUpdate()}render(){return c`
    ...
    `}};h(Se,"properties",{activeDetector:{type:String},handleComplete:{type:Function},constructTime:{type:Number}});customElements.get("trtc-camera-detector")||customElements.define("trtc-camera-detector",Se);var Ie=class extends f{constructor(){super();h(this,"handleMicrophoneChange",async i=>{this.choseDevice=i;let{deviceId:r,label:V}=i;this.localStream?(this.localStream.getTracks().forEach(o=>o.stop()),this.timer&&clearInterval(this.timer),this.initStream(r)):this.initStream(r),this.microphoneID=r,this.microphoneLabel=V,this.device=i});this.currentDetector="microphone",this.localStream=null,this.microphoneID="",this.microphoneLabel="",this.volumeNum=0,this.choseDevice=null,this.timer=null,this.time=null,this.recording=!1,this.recordingTime=0,this.audioURL="",this.recorder=null,this.chunks=[],this.disconnect=!1,this.device=null;let i=navigator.language||navigator.userLanguage||navigator.browserLanguage||navigator.systemLanguage||"en";this.isChinese=i.indexOf("zh")>-1,this.attachShadow({mode:"open"}),this.core=M(),this.log=x()}updated(i){var r;i.has("activeDetector")&&this.activeDetector===this.currentDetector&&!this.localStream&&this.microphoneID&&this.initStream(this.microphoneID),this.activeDetector!==this.currentDetector&&((r=this.localStream)==null||r.getTracks().forEach(V=>{V.stop()}),this.timer&&clearInterval(this.timer))}handleError(){var r;this.log&&this.log.warn("MicphoneFail",this.device);let i=new Date().getTime();this.core&&this.core.kvStatManager.addFailedEvent({key:591708,error:i-this.constructTime}),this.handleComplete("error",this.microphoneLabel,!1,this.device,this.audioURL),(r=this.localStream)==null||r.getTracks().forEach(V=>{V.stop()}),this.timer&&clearInterval(this.timer)}handleSuccess(){var r;let i=new Date().getTime();this.core&&this.core.kvStatManager.addSuccessEvent({key:591707,cost:i-this.constructTime}),this.handleComplete("success",this.microphoneLabel,!0,this.device,this.audioURL),(r=this.localStream)==null||r.getTracks().forEach(V=>{V.stop()}),this.timer&&clearInterval(this.timer)}firstUpdated(){}async initStream(i){this.localStream=await navigator.mediaDevices.getUserMedia({audio:{deviceId:i},video:!1});let r=new AudioContext,V=r.createAnalyser(),o=r.createMediaStreamSource(this.localStream);V.smoothingTimeConstant=.8,V.fftSize=1024,o.connect(V),this.timer=setInterval(()=>{let s=new Uint8Array(V.fftSize);V.getByteTimeDomainData(s);let A=0,{length:n}=s;for(let u=0;u<n;u++)A+=s[u];let l=(A/n-128)/128;this.volumeNum=Math.round(Math.abs(l*28)*50),this.requestUpdate()},100)}handleRecordClick(){let i=this.shadowRoot.querySelector(".recordingbutton");this.recording?(i.setAttribute("type","outlined"),this.recording=!1,this.recordingStartTime=null,this.time&&clearInterval(this.time),this.recorder.stop()):(i.setAttribute("type","contained"),this.recording=!0,this.recordingStartTime=Date.now(),this.recordingTime=0,this.time=setInterval(()=>{this.recordingTime=((Date.now()-this.recordingStartTime)/1e3).toFixed(2)},100),this.startRecording())}startRecording(){this.localStream&&(this.recording=!0,this.recorder=new MediaRecorder(this.localStream),this.recorder.start(),this.recorder.ondataavailable=i=>{this.chunks.push(i.data)},this.recorder.onstop=()=>{let i=new Blob(this.chunks,{type:"audio/ogg; codecs=opus"});this.audioURL=window.URL.createObjectURL(i)})}disconnectedCallback(){this.localStream&&this.localStream.getTracks().forEach(i=>{i.stop()}),this.timer&&clearInterval(this.timer),this.disconnect=!0,this.core=null,this.log=null,this.remove()}render(){return this.disconnect&&this.timer&&clearInterval(this.timer),this.activeDetector===this.currentDetector?c`
        ...
        `:c``}};h(ve,"properties",{activeDetector:String,networkDetectInfo:Object,handleComplete:Function,generateReport:Function,testResult:Object,hasStartLocalVideo:Boolean,setHasStartLocalVideo:Function,constructTime:Number});customElements.get("trtc-network-detector")||customElements.define("trtc-network-detector",ve);var Ce=class extends f{constructor(){super();let e=navigator.language||navigator.userLanguage||navigator.browserLanguage||navigator.systemLanguage||"en";this.isChinese=e.indexOf("zh")>-1,this.attachShadow({mode:"open"})}render(){return c`
    <style>${v}</style>
          ...
          ${this.reportData.network?c`
            ...
            <div class="device-report">
              ...
              <div class="${this.goodUplinkQuality?"green":"red"}">
                ${this.isChinese?vs[this.reportData.network.result.quality]:Cs[this.reportData.network.result.quality]}
              </div>
            </div>
            `:""}
        </div>
